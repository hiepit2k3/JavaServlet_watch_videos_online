	...
	<section id="main">
		...
		<div class="main__body">
			...
			<div class="main__body__data" style="width: 100%">
				<form style="width: 100%" action="addVideo" method="post" accept-charset="UTF-8">
					<div class="form-group">
						<label for="ma-video">Mã Video:</label> <input type="text"
							class="form-control" id="ma-video" name="id">
					</div>
					<div class="form-group">
						<label for="tieu-de">Tiêu Đề Video:</label> <input type="text"
							class="form-control" id="tieu-de" name="title">
					</div>
					<div class="form-group">
						<label for="mo-ta">Mô Tả Video:</label>
						<textarea class="form-control" id="mo-ta" name="descriptions" rows="3"></textarea>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="link-video">Link Video:</label> <input type="text"
							class="form-control" id="link-video" name="urlvideo">
					</div>
					<button type="submit" class="btn btn-primary" formaction="addVideo">Thêm mới</button>
				</form>
