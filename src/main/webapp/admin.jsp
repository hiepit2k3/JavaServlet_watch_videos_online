...
<body>
	...
	<section id="sidebar">
		...
		<ul class="sidebar__menu">
			...
			<li title="Đăng Xuất"><a href="logout" class="logout"><i class="ph-sign-out-fill"></i></a>
			</li>
		</ul>
	</section>
						...
						<div class="content-box">
							...
							<table style="width: 100%" class="table">
								<tr>
									...
									<th scope="col">URL Videos</th>
									<th scope="col"></th>
								</tr>
								<tbody>
									<c:forEach var="v" items="${listvideo}">
										<tr>
											<td><img src="${v.poster}" class="pro-img"
												style="width: 200px; height: auto;"></td>
											<td>${v.title}</td>
											<td>${v.views}</td>
											<td>${v.urlvideo}</td>
											<td><a href="editVideo?id=${v.id}"
												style="text-decoration: none; font-size: 14px; color: #00a97f"><button
														class="editbutton" name="">edit</button></a> 
												<a href="deleteVideo?id=${v.id}">
