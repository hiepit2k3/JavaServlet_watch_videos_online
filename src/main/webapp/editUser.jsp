			...
			<div class="main__body__data" style="width: 100%">
				<form style="width: 100%" action="updateVideo" method="post">
					<div class="form-group">
						<label for="ma-video">Tên đăng nhập:</label> <input type="text"
							class="form-control" id="ma-video" name="id" value="${user.id}">
					</div>
					<div class="form-group">
						<label for="tieu-de">Mật Khẩu:</label> <input type="text"
							class="form-control" id="tieu-de" name="password" value="${user.password}">
					</div>
					<div class="form-group">
						<label for="mo-ta">Email:</label>
						<input class="form-control" id="mo-ta" name="email" value="${user.email }">
					</div>
					<div class="form-group">
						<label for="anh-thu-nho">Họ Tên:</label> <input
							type="text" class="form-control" id="anh-thu-nho"
							name="fullname" value="${user.fullname}">
					</div>
					<div class="form-group">
						<label for="link-video">Loại:</label>
						<div class="form-check form-check-inline">
						<label for="" class="ml-2"> <input
							type="radio" class="form-check-input" id="admin" name="isAdmin"
							value="true" checked="${user.isAdmin ? 'checked' : ''}">
							Admin
						</label> 
						<label for="" class="ml-2"> <input type="radio"
							class="form-check-input" id="user" name="isAdmin" value=""
							${!user.isAdmin ? 'checked' : ''}> User
						</label>
					</div>
					</div>
					
					<button type="submit" class="btn btn-primary" formaction="updateUser">Cập Nhật</button>
				</form>
